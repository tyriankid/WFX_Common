...
<div class="areacolumn clearfix">
      ...
      <div class="formitem validator4">
        <ul>
          ...
          <abbr class="formselect"> <asp:DropDownList ID="DrStatus" runat="server">
          ...
          <li>
              <span class="formitemtitle Pw_110"><em >*</em>代理商等级:</span>
              <abbr>
                 <Hi:AgentGradeDropDownList ID="DrAgentGrade" runat="server" AllowNull="false" Height ="30"></Hi:AgentGradeDropDownList>
              </abbr>
          </li>
