...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
    ...
    <div class="dataarea mainwidth databody">
        ...
        <div class="datalist">
            <div class="functionHandleArea padding-no-left">
                <!--分页功能-->
                ...
                <div class="searcharea clearfix br_search">
                    <ul class="a_none_left">
                        ...
                        <li><input type="button" id="btnQd" class="allSelect" style="width:66px;height:27px;line-height:27px;background:#F55656;color:#fff;border-radius:3px" value="确认选择"/></li>
                    </ul>
                </div>
                </div>
                <!--结束-->
                            ...
                            <td width="77%">
                                <ul>
                                    <li class="batchHandleButton"><span class="signicon"></span>
                                        ...
                                        <span id="swfu_container" style="display:none;"><span>
                                            <span id="spanButtonPlaceholder"></span></span><span
            ...
            <div class="imageDataLeft" id="ImageDataList" style="width:100%;">
                <!--图片列表begin-->
                    ...
                    <ItemTemplate>
                        <div class="imageItem imageLink">
                            ...
                            <ul>
                                ...
                                <label>
                                    <input type="checkbox" ID="checkboxCol"  />选择</label>&nbsp;
            ...
            <div class="batchHandleArea">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td width="77%">
                            <ul>
                                <li class="batchHandleButton"> <span class="moveSelect">
    ...
    <script type="text/javascript" language="javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnQd").click(function(){
                var url = $("input:checked").parent().parent().prev().find("img").parent().attr("href");
                window.parent.setImg(url);
                window.parent.closechsImg();
            });
        });
