<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="EditProductArea.aspx.cs" Inherits="Hidistro.UI.Web.Admin.product.EditStocks" Title="无标题页" %>
...
<div class="dataarea mainwidth databody">
	<div class="title"> <em><img src="../images/01.gif" width="32" height="32" /></em>
	    <h1 class="title_line">批量修改商品所属范围</h1>
	    <span class="font">您可以对已选的这些商品进行设置商品的所属范围</span>
    </div>
