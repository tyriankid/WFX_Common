	...
	public class ManageLotteryActivity : AdminPage
	{
		...
		public string GetUrl(object activityId)
		{
            ...
            case 6:
                result = string.Concat(new object[]
				{
					"/Vshop/RemoveBox.aspx?activityid=",
					activityId
				});
                break;
            case 9:
                result = string.Concat(new object[]
				{
					//"http://",
					//Globals.DomainName,
					"/Vshop/BigWheelEx.aspx?activityid=",
					activityId
				});
                break;
			default:
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			else
			{
				...
				case 3:
					...
					break;
                case 6:
                    this.addactivity.InnerText = "添加拆礼盒";
                    this.LitTitle.Text = "拆礼盒活动管理";
                    this.Litdesc.Text = "拆礼盒";
                    break;
                case 9:
                    this.addactivity.InnerText = "添加红包";
                    this.LitTitle.Text = "微信红包活动管理";
                    this.Litdesc.Text = "微信红包";
                    break;
				}
