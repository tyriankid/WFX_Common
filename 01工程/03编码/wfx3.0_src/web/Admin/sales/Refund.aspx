                            ...
                            <td>
                                <a href='<%# "ReturnsapplyDetail.aspx?ReturnsId="+Eval("ReturnsId") %>'>详情</a>
                                 ...
                                 <a href="javascript:void(0)"  style='<%# Eval("HandleStatus").ToString()=="5"||Eval("HandleStatus").ToString()=="6"?"":"display:none" %>'
                                    onclick="return CheckRefund('<%# Eval("ReturnsId") %>','<%# Eval("RefundMoney","{0:F2}") %>', '<%# Eval("Comments").ToString().Replace("\n","，")%>','<%# Eval("ProductId")%>','<%# Eval("OrderId")%>','<%# Eval("HandleStatus")%>')"  id="lkbtnCheckRefund"
                                     >退款</a>
                            </td>
                        </tr>
                    </ItemTemplate>
