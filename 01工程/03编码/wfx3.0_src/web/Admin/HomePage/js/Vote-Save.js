...
function save() {
    if (window.confirm('保存将清除所有投票结果，确认保存？')) {
        if (check()) {
            var res = "";
                ...
                switch (modelName) {
                    ...
                    case "ShuRuKuang":
                        ...
                        if ($(this).attr("bt") == "true")
                            ...
                            res += "0●";//显示个数,这里做必填
                        //***********************内容开始***********************     
                        res += $(this).find(".wz").children("h3").text() + "♦";//得到标题
                        res += $(this).find(".wz").children("h4").text();//得到副标题
                        //***********************内容结束*********************** 
                        break;
                    case "ShiJian":
                        res += "●";//高度
                    ...
                    case "XuanXiang":
                        ...
                        if ($(this).find("ul li").length > 0)
                            res += $(this).find("ul li:eq(0)").find("input").attr("type") + "●";//类型、样式
                        else
                            res += "●";//类型、样式
                        if ($(this).attr("bt") == "true")
                            res += "1●";//显示个数,这里做必填
                            ...
                            res += "0●";//显示个数,这里做必填
                        //***********************内容开始***********************
                        res += $(this).find(".wz").children("h3").html() + "♦";//得到标题
                        res += $(this).find(".wz").children("h4").html() + "♦";//得到副标题
                        var ivalue = 0;
                        $(this).find("ul li").each(function () {
                            ivalue++;
                            //选项
                            res += ivalue + "□";//选项值
                            res += $(this).find("span").text() + "□";//选项显示名称
                            //res += $(this).find("input").attr("type") + "□";//选择项类型(redio/checkbox)
                            res += $(this).html();//选项Html内容
                            res += "♢";
                        });
                        //***********************内容结束*********************** 
                        break;
