	 ...
	 <UI:Grid ID="grdShippingTemplates" runat="server" ShowHeader="true" AutoGenerateColumns="false" DataKeyNames="TemplateId" GridLines="None" Width="100%" HeaderStyle-CssClass="border_background">
          <HeaderStyle CssClass="table_title" />
            <Columns>   
                    ...
                    <asp:BoundField HeaderText="首重" DataField="Weight" DataFormatString ="{0:f2}" ItemStyle-CssClass="td_txt_right"   />
                    <asp:TemplateField HeaderText="起步价" ItemStyle-CssClass="td_txt_right">
                        <ItemTemplate>
                            <Hi:FormatedMoneyLabel ID="FormatedMoneyLabelForAdmin1" runat="server" Money='<%# Eval("Price") %>'></Hi:FormatedMoneyLabel>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField HeaderText="加重"  DataField="AddWeight" DataFormatString ="{0:f2}" ItemStyle-CssClass="td_txt_right"  />
                    <asp:TemplateField HeaderText="加价" ItemStyle-CssClass="td_txt_right" >
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="操作" HeaderStyle-Width="95" ItemStyle-CssClass="td_txt_cenetr">
                        <ItemStyle CssClass="spanD spanN" />
                           <ItemTemplate>
	                           <a href='<%# "EditShippingTemplate.aspx?TemplateId="+Eval("TemplateId")%>' class="SmallCommonTextButton">编辑</a>
	                           <Hi:ImageLinkButton runat="server" ID="Delete" CommandArgument='<%# Eval("TemplateId") %>' CommandName="DEL_Template" IsShow="true" CssClass="SmallCommonTextButton" Text="删除"/>
                           </ItemTemplate>
                    </asp:TemplateField>
