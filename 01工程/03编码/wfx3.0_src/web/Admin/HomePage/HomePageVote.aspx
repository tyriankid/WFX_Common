<%@ Page Language="C#"  AutoEventWireup="true" CodeBehind="HomePageVote.aspx.cs" Inherits="Hidistro.UI.Web.Admin.HomePage.HomePageVote" %>
<!doctype html>
<html lang="en">
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/vote-style.css"/>
    ...
    <script src="js/mobiscroll_time.js" type="text/javascript" charset="utf-8"></script>
    <script src="js/mobiscroll.js" type="text/javascript" charset="utf-8"></script>

    <script src="js/vote-databind.js" type="text/javascript" charset="utf-8"></script>	
    <script src="js/vote-Save.js"  type="text/javascript" charset="utf-8"></script>
	<style type="text/css">
		.slides{
			position: relative;
		}
...
<body>
	...
	<div class="draw">
		...
		<ul>
            <li class="character"><a href="javascript:;">输入框</a></li>
            <li class="calendar"><a href="javascript:;">日期<br />控件</a></li>
            <li class="text-voting"><a href="javascript:;">投票<br />选项</a></li>
        ...
        <asp:Button ID="btnReset" CssClass="btn3" runat="server" Text="还原到初始模板" />
	</div>
	</div>
	...
	<div class="subBtn">
        ...
        <script src="js/vote-jquery.draw.js" type="text/javascript" charset="utf-8"></script>
        </form>
</body>
</html>
