...
<div id="divexpresscomputers" style="display: none;">
        ...
        <div class="frame-content">
            ...
            <p><span class="frame-span frame-input100"><em>*</em>&nbsp;公司名称：</span><asp:TextBox ID="txtAddCmpName" CssClass="forminput" Width="250" runat="server" /></p>
            <p><span  class="frame-span frame-input100"><em>*</em>&nbsp;快递100Code：</span><asp:TextBox ID="txtAddKuaidi100Code" CssClass="forminput" Width="250" runat="server"></asp:TextBox></p>
            <p><span  class="frame-span frame-input100"><em>*</em>&nbsp;淘宝Code：</span><asp:TextBox ID="txtAddTaobaoCode" CssClass="forminput" Width="250" runat="server"></asp:TextBox></p>
        </div>
</div>
