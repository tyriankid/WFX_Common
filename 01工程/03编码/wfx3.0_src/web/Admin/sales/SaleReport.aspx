	  ...
	  <div class="datalist">
         <div class="clearfix search_titxt2">
		    ...
		    <li><span>请选择：</span>
             ...
             <li><p><asp:LinkButton ID="btnCreateReportOfMonth" CssClass="shengc_a" runat="server" Text="生成报告"/></p></li>
			</ul>
	  </div>
	  </div>
        ...
        <div>      
          ...
          <div class="datalist">
            ...
            <ul class="a_none_left">
              ...
              <li>
                <p> <asp:LinkButton ID="btnCreateReportOfDay" CssClass="shengc_a" runat="server" Text="生成报告" /></p>
              </li>
            </ul>
          </div>
          </div>
