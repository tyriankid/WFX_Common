...
public class Code128Helper
    {

    private static Code128Helper _instance;
    public static Code128Helper Instance()
    {
        if (_instance == null)
        {
            _instance = new Code128Helper();
            _instance.Code128();
        }
        return _instance;
    }
        ...
        private DataTable m_Code128 = new DataTable();
            ...
            private Font m_ValueFont = new Font("宋体", 30);
            /// <summary>
