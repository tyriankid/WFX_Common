...
function dhAttr() {
	var divhtml = "<div id='addAttr"+i+"' class='addAttr' i='"+i+"'>"+
					  "<table class='nature' cellpadding='0' cellspacing='0' border='0'>"+
						  "<tr><td align='right'>显示方式：</td><td><input type='radio' name='way" + i + "' value='two' />一行两列</td><td><input type='radio' name='way" + i + "' value='three' />一行三列</td><td><input type='radio' name='way" + i + "' value='four' checked='checked' />一行四列</td></tr>" +
