...
<div class="dataarea mainwidth databody">
  ...
  <div class="Purchase">
   ...
   <div class="list">
      ...
      <div class="Settlement">
        <style>
         ...
         <table width="100%" border="0" cellspacing="0"  class="br_none" role="wuliu" >
          ...
          <tr>
              <%--style="display:<%=Hidistro.ControlPanel.Config.CustomConfigHelper.Instance.BrandShow?"none":"" %>"--%>
            <td >运单号码：</td>
            <td   id="tdShipOrderNumber" class="a_none"><asp:TextBox runat="server" ID="txtShipOrderNumber"  class="forminput"/> 
                <span id="txtShipOrderNumberTip" runat="server" style="line-height:30px;">&nbsp;运单号码不能为空，在1至20个字符之间</span>
            </td>
           </tr>
          <tr role="arriveTime">
              <%--style="display:<%=Hidistro.ControlPanel.Config.CustomConfigHelper.Instance.BrandShow?"none":"" %>"--%>
            <td >送达时间：</td>
            <td   id="tdArriveTime" class="a_none"><asp:TextBox runat="server" ID="txtArriveTime"  class="forminput"/> 
                <span id="txtArriveTimeTip" runat="server" style="line-height:30px;">&nbsp;送达时间不能为空，格式随意填写</span>
            </td>
           </tr>
    ...
    <input type="hidden" runat="server" id="specialHideShow" />
...
<script type="text/javascript">
        function InitValidators() {
            initValid(new InputValidator('ctl00_contentHolder_txtShipOrderNumber', 1, 20,true, null, '运单号码不能为空，在1至20个字符之间'));
        }
    ...
    $(function () {
        if ($("#ctl00_contentHolder_specialHideShow").val() == "prola") {
            $("[role='wuliu'] tr:not([role='arriveTime'])").hide();
        }
    })
