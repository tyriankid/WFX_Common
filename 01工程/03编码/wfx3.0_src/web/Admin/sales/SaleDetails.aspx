  ...
  <span>查询一段时间内每个订单内的商品销售量及销售价，默认排序为售出时间由新到旧(注：统计的商品不包括成功退款订单中的商品)。</span>
      ...
      <div class="blank12 clearfix"></div>
	    <asp:GridView ID="grdOrderLineItem" runat="server"  AutoGenerateColumns="false" ShowHeader="true" AllowSorting="true"  GridLines="None" HeaderStyle-CssClass="table_title" >                                                        
                                    <Columns>  
                                     <asp:BoundField HeaderText="订单号" DataField="OrderId" ItemStyle-Width="25%" ItemStyle-CssClass="td_txt_cenetr" />                                                                                                                                                                                                                                                                                                                                                                
                                        <asp:BoundField HeaderText="商品名称" DataField="ProductName" HeaderStyle-CssClass="td_right td_left"/>    
                                       
                                        <asp:BoundField HeaderText="数量" DataField="Quantity"  ItemStyle-CssClass="td_txt_right" />
                                        <Hi:MoneyColumnForAdmin HeaderText="价格" DataField="ItemAdjustedPrice"  ItemStyle-CssClass="td_txt_right" />
                                        <asp:TemplateField HeaderText="成交时间"  ItemStyle-CssClass="td_txt_cenetr" >
                                            <ItemTemplate>
