          ...
          <div class="formitem validator2">
            ...
            <div class="Pa_128 Pg_8 clear">
              ...
              <p id="ctl00_contentHolder_txtPageKeyWordsTip"></p>
                ...
                -->
            <li style="margin-bottom:0px;"><span class="formitemtitle Pw_100">分类大图：</span>
                <asp:FileUpload ID="bannerImgUpload" runat="server" />
                <p id="txtKeywordTip"> 推荐图片尺寸1080*600</p>
                <div style="padding:3px"><a name="imgLink"><asp:Image ID="bannerImg" runat="server" style="height:50px"/></a></div>
