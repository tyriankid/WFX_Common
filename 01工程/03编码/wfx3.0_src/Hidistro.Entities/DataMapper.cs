namespace Hidistro.Entities
{
    ...
    public static class DataMapper
    {
        ...
        public static BrandCategoryInfo ConvertDataRowToBrandID(DataRow row)
        {
            ...
            {
                info.Logo = (string)row["Logo"];
            }
            if (row["CompanyUrl"] != DBNull.Value)
            {
                info.CompanyUrl = (string)row["CompanyUrl"];
            }
            if (row["RewriteName"] != DBNull.Value)
            {
                info.RewriteName = (string)row["RewriteName"];
            ...
            if (row["MetaKeywords"] != DBNull.Value)
            {
                info.MetaKeywords = row["MetaKeywords"].ToString();
            }
            if (row["MetaDescription"] != DBNull.Value)
            {
                info.MetaDescription = row["MetaDescription"].ToString();
            }
        ...
        public static OrderGiftInfo PopulateOrderGift(IDataRecord reader)
        {
            ...
            return new OrderGiftInfo { 
                ...
                costPoint = (int)reader["costPoint"]
            };
        }
        ...
        public static LineItemInfo PopulateLineItem(IDataRecord reader)
        {
            ...
            if (reader["HalfQuantity"] != DBNull.Value)
            {
                info.HalfPriceQuantity = (int)reader["HalfQuantity"];
            }
        ...
        public static OrderInfo PopulateOrder(IDataRecord reader)
        {
            ...
            if (DBNull.Value != reader["ReferralUserId"])
            {
             info.ReferralUserId = (int)reader["ReferralUserId"];
            }
        ...
        public static ProductInfo PopulateProduct(IDataReader reader)
        {
            ...
            {
                info.BrandId =reader["BrandId"].ToString();
            }
            if (reader["MainCategoryPath"] != DBNull.Value)
            {
                info.MainCategoryPath = (string)reader["MainCategoryPath"];
        ...
        public static ShippingAddressInfo PopulateShippingAddress(IDataRecord reader)
        {
            ...
            {
                info.lat = float.Parse(reader["lat"].ToString());
            }
            if (reader["lat"] != DBNull.Value)
            {
                info.lng = float.Parse(reader["lng"].ToString());
            }
