		...
		<div class="columnright">
		  ...
		  <div class="datafrom">
            <div class="formitem validator1">
                      <ul>
		      <li>
		      <span class="formitemtitle Pw_140"><em >*</em>支付接口类型：</span>
		        <abbr class="formselect">
		            <select id="ddlPayments" name="ddlPayments"></select>
                </abbr>
	          </li>
		      <li style=" margin-bottom:0px;"> <span class="formitemtitle Pw_140"  ><em >*</em>支付方式名称：</span>
              ...
              <div class="formitem2" style="padding:0px 0 0 45px;">
	              ...
	              <li rowtype="attributeTemplate" style="display:none; clear: both; margin-top:18px; overflow:hidden;" >
	               <span class="formitemtitle Pw_140" style=" display:block;float:left; font-size:14px; text-align:right">$Name$：</span>
		            $Input$
	              </li>
	              </ul>
                </div>
	          ...
	          <ul>
	          <li>
              <span class="formitemtitle Pw_140 "><em >*</em>手续费：</span>
              <asp:TextBox ID="txtCharge" runat="server"   CssClass="forminput"></asp:TextBox><asp:CheckBox ID="chkIsPercent" runat="server" Text="百分比" />
               <p class="Pa_140" id="ctl00_contentHolder_txtChargeTip">支付手续费大小0-10000000之间</p>
	          </li>
	          <li>
              <span class="formitemtitle Pw_140 "><em >*</em>用于预付款充值：</span>
              <Hi:YesNoRadioButtonList runat="server" ID="radiIsUseInpour" RepeatLayout="Flow" />
               <p class="Pa_140" id="P1">用于预付款充值的支付方式最好是即时到帐的支付方式，方便立即查看预付款</p>
	          </li>
              <li style=" margin-bottom:0px;">
              <span class="formitemtitle Pw_140 "><em >*</em>用于采购单付款：</span>
              <Hi:YesNoRadioButtonList runat="server" ID="radiIsUseInDistributor" RepeatLayout="Flow" />
               <p class="Pa_140" id="P2"></p>
	          </li>
           <li class="clearfix"> <span class="formitemtitle Pw_140">备注：</span>
