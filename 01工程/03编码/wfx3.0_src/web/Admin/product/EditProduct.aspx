	    ...
	    <div class="formitem validator1">
          ...
          <li><h2 class="colorE">基本信息</h2></li>
	        ...
	        <li>
	            ...
	            <span id="spDropDownList" runat="server">品牌：</span><abbr class="formselect"><Hi:BrandCategoriesDropDownList runat="server" ID="dropBrandCategories" NullToDisplay="--请选择--" /></abbr>
            </li>
            <li>
                <span id="spCheckBox" class="formitemtitle Pw_198" runat="server">展示分类：</span><abbr class="formselect" style="visibility:visible"><Hi:BrandCategoriesCheckBoxList  runat="server" ID="BrandCategories"  /></abbr>
            </li>
	        ...
	        <li id="salePriceRow"><span class="formitemtitle Pw_198">一口价：<em >*</em></span>
              <Hi:TrimTextBox runat="server" CssClass="forminput" ID="txtSalePrice" />元<input type="button" class="inp_edit" onclick="editProductMemberPrice();" value="编辑会员价" />
            ...
            <li id="rangeRow"><span class="formitemtitle Pw_198">商品显示范围：</span>
                <asp:DropDownList ID="DDLRange" runat="server">
                    ...
                    <asp:ListItem Value="98">机场PC端</asp:ListItem>
                    <asp:ListItem Value="99">机场手机端</asp:ListItem>
                </asp:DropDownList>
            </li>
