namespace Hidistro.ControlPanel.Commodities
{
    ...
    public static class ProductHelper
    {
        ...
        private static ProductInfo ConverToProduct(DataRow productRow, int categoryId, int lineId, string bandId, ProductSaleStatus saleStatus, bool includeImages)
        {
        ...
        public static string GetReviewProductIds(string storeid = "")
        {
            return new ProductBatchDao().GetReviewProductIds(storeid);
        }

        public static bool GoReview(string productids,string refuseReason,string reviewType)
        {
            return new ProductBatchDao().GoReview(productids,refuseReason,reviewType);
        }
        ...
        public static DbQueryResult GetProductsByStoreId(ProductQuery query)
        {
            return new ProductDao().GetProductsByStoreId(query);
        }
        ...
        public static void ImportProducts(DataSet productData, int categoryId, int lineId, string bandId, ProductSaleStatus saleStatus, bool includeCostPrice, bool includeStock, bool includeImages)
        {
        ...
        public static bool UpdateProductReviewState(int state, string productIds)
        {
            return new ProductBatchDao().UpdateProductReviewState(state, productIds);
        }
        ...
        public static bool UpdateProductSaleStatus(string productIds, ProductSaleStatus status)
        {
            return new ProductDao().UpdateProductSaleStatus(productIds, status)>0;
        }
    }
}
