...
{
    public class AddProductReview : AdminPage
	{
        protected System.Web.UI.WebControls.Button btnCancelFreeShip;
        protected ImageLinkButton btnDelete;
        protected LinkButton addReviews;//添加评论按钮
        protected TextBox txt_Review;//评论内容
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            this.grdProducts.RowDeleting += new System.Web.UI.WebControls.GridViewDeleteEventHandler(grdProducts_ItemCommand);
