...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
     <div class="dataarea mainwidth databody">
        <div class="columnright">
            ...
            <div class="clear friend-share-box">
                <div class="add">
                    <a class="share_a" href="AddFriendExtension.aspx">+ 添加朋友分享</a>
                </div>
                        ...
                        <ItemTemplate>
                            <li>
                                ...
                                <p class="clearfix">
                                    ...
                                    <Hi:ImageLinkButton ID="lkbtnConfirmPurchaseOrder" CssClass="delete_a" IsShow="true" runat="server" Text="删除"
                                        CommandArgument='<%# Eval("ExtensionId") %>' CommandName='Del' DeleteMsg="确认要删除吗？" 
                                        ForeColor="Red" /><a class="bianji_a" href='EditFriendExtension.aspx?ExtensionId=<%# Eval("ExtensionId") %>'>编辑</a></p>
                            </li>
                        </ItemTemplate>
                    </asp:Repeater>
                </ul>
