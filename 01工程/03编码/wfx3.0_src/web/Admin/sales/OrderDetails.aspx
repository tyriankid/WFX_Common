      ...
      <div class="Settlement">
        ...
        <td>
          <ul class="order_ul">
        	<li></li>
            <li class="order_li">
                <span>昵称：<asp:Literal runat="server" ID="litUserName" />
                </span><span>真实姓名：<asp:Literal runat="server" ID="litRealName" />
                </span><span>联系电话：<asp:Literal runat="server" ID="litUserTel" />
                </span><span>电子邮件：<asp:Literal runat="server" ID="litUserEmail" /></span>
            </li>
            <li class="order_li">
                <span><asp:Literal ID="litPayTime"  runat="server" />
                </span><span><asp:Literal ID="litSendGoodTime"  runat="server" />
                </span><span><asp:Literal ID="litFinishTime"  runat="server" /></span>
            </li>
            <li class="Pg_8"><span><asp:HyperLink runat="server" ID="lkbtnEditPrice" class="link_default_blue" Text="修改价格" /></span>
