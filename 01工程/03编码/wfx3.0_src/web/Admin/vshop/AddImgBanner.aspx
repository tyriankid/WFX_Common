<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AddImgBanner.aspx.cs" Inherits="Hidistro.UI.Web.Admin.vshop.AddImgBanner" %>
...
<div class="areacolumn clearfix">
      <div class="columnright">
          <div class="title">
            ...
            <h1>添加大图</h1>
            <span class="font">添加大图</span>
      </div>
          <div class="formitem validator2">
            <ul>
              <li><span class="formitemtitle Pw_100">大图描述：</span>
              ...
              <asp:TextBox ID="Tburl" style="display:none; Width:350px" CssClass="forminput" runat="server" ClientIDMode="Static"></asp:TextBox>
                                  <span ID="navigateDesc" runat="server" style="display:none;"><a target="_blank" href="#">获取导航地址</a></span>
              </li>
            </ul>
