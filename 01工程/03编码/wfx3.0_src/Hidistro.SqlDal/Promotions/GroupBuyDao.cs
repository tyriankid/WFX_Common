namespace Hidistro.SqlDal.Promotions
{
    ...
    public class GroupBuyDao
    {
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("a.GroupBuyId,a.ProductId,a.ProductName,b.ProductCode,b.ShortDescription,SoldCount,ProdcutQuantity,");
            ...
            builder2.Append(" vw_Hishop_GroupBuy a left join vw_Hishop_BrowseProductList b on a.ProductId = b.ProductId  ");
