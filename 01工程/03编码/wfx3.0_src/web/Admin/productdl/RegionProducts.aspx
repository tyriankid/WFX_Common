<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="RegionProducts.aspx.cs" Inherits="Hidistro.UI.Web.Admin.product.RegionProducts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
    <div class="dataarea mainwidth databody">
        <div class="title">
            ...
            <h1>
                设置区域商品</h1>
            <span>店铺中所有的商品，您可以对商品进行区域的划分</span>
        </div>
        <div class="datalist">
            <!--搜索-->
            ...
            <div class="searcharea clearfix" style="padding: 10px 0px 3px 0px;">
                <asp:HiddenField ID="txtSelectedProduct" runat="server" ClientIDMode="Static" />
                <ul
                ...
                <div class="batchHandleArea">
                    <ul>
                        <li class="batchHandleButton">
                            ...
                            <span class="downproduct"><a href="javascript:void()" onclick="SetRegions()">设置商品区域</a></span>
                            <span class="delete"><a href="javascript:void()" onclick="SetRemove()"><Hi:ImageLinkButton ID="btnRemove" runat="server" Text="清除区域关系" IsShow="true" DeleteMsg="确定要清除商品区域关系吗？" OnClientClick="SetRemove()" /></a></span>
