<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="BuyToGive.aspx.cs" Inherits="Hidistro.UI.Web.Admin.BuyToGive" %>
...
<div class="dataarea mainwidth databody">
      <div class="title"> <em><img src="../images/01.gif" width="32" height="32" /></em>
        <h1>买一送一配置</h1>
        <span>买一送一活动启停配置</span>
      </div>
      <div class="datafrom">
          <div class="formitem validator1">
              <ul>
                  <li><span class="formitemtitle Pw_198"><em >*</em>买一送一状态：</span>
