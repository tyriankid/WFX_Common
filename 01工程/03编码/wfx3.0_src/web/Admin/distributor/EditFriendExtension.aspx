        ...
        $(function () {
            ...
            if ($("#ctl00_contentHolder_hidpic").val() != "") {
                ...
                for (var i = 0; i < imgarry.length; i++) {
                    if (imgarry[i] != "")
                        $("#imgall").append("<span id='span" + i + "' style='margin-right:10px;float:left'><img src='" + imgarry[i] + "' width='180' height='120'/></br><a style=\"text-align:center;cursor: pointer;\" onclick=EditDelImg('" + imgarry[i] + "|','span" + i + "')><span style=\"width: 100%; font-size:12px;\">删除</span></a></span>");
                }
            }
            else {
                loader(0);
