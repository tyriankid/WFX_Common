...
namespace Hidistro.UI.Web.Admin.vshop
{
    public partial class RedPagerActivityList1 : AdminPage
    {
        ...
        protected void rptList_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                ImageButton imageButton = (ImageButton)e.Item.FindControl("imgBtnIsOpen");
                if (((DataRowView)e.Item.DataItem).Row["IsOpen"].ToString() == "False")
                {
                    imageButton.ImageUrl = "../images/ta.gif";
                    imageButton.CommandName = "open";
                    imageButton.ToolTip = "点击开通该代金券活动";
                }
                else
                {
