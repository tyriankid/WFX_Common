...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
  <div class="dataarea mainwidth databody">
    ...
    <div class="formitem">
    <ul>
    <li><span class="formitemtitle Pw_101">生成规则：</span><input type="radio" name="radioadd" value="1" onclick="selecttype(1)" checked="true"  id="radionumber" runat="server" />指定数量生成<input type="radio" name="radioadd" value="2" onclick="selecttype(2)" id="radioaccount" runat="server"  />指定账号生成</li>
    </ul>
     <ul>
    <li><span class="formitemtitle Pw_101">推荐分销商：</span><input type="text" id="txtslsdistributors" class="forminput" name="txtslsdistributors" runat="server" autocomplete="off" /></li>
    </ul>
    <ul>
    <li><span class="formitemtitle Pw_101">输入生成数量：</span><input type="text" class="forminput" name="txtnumber" id="txtnumber" runat="server" />
     <p>请输入1~999的正整数</p>
    </li>
    </ul>
      <ul>
        <li> <span class="formitemtitle Pw_101">指定账号生成：</span>
        <textarea id="txtdistributornames" name="txtdistributornames" rows="8" wrap="off" cols="50" runat="server"></textarea>
          <p>每个分销商账号在2~10个英文字符，一行一个</p>
        </li>
        </ul>
                <ul class="btntf" style="padding-left:150px;"><li><asp:Button runat="server" ID="batchCreate" Text="生 成" class="submit_DAqueding inbnt" OnClientClick="return vailidbatch()"  /><asp:Button runat="server" ID="btnExport" Visible="false" Text="导出分销商" class="submit_DAqueding submit_DAqueding2 inbnt"/></li>      
          </ul>
      </div>
    </div>
</div>
