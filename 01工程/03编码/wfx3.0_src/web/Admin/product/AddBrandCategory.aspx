...
<div class="areacolumn clearfix">
      <div class="columnright">
          <div class="title">
            ...
            <h1>添加<%=Hidistro.ControlPanel.Config.CustomConfigHelper.Instance.BrandShow?"展示":"品牌" %>分类</h1>
            <span>管理商品所属的各个<%=Hidistro.ControlPanel.Config.CustomConfigHelper.Instance.BrandShow?"展示分类":"品牌" %>，如果在上架商品时给商品指定了<%=Hidistro.ControlPanel.Config.CustomConfigHelper.Instance.BrandShow?"展示":"品牌" %>分类，则商品可以按<%=Hidistro.ControlPanel.Config.CustomConfigHelper.Instance.BrandShow?"展示":"品牌" %>分类浏览 </span>
          </div>
      <div class="formitem validator2">
        <ul>
          <li> <span class="formitemtitle Pw_100"><em >*</em>名称：</span>
            <asp:TextBox ID="txtBrandName" CssClass="forminput" runat="server" />
            <p id="ctl00_contentHolder_txtBrandNameTip">名称不能为空，长度限制在30个字符以内</p>
          </li>
          <li> <span class="formitemtitle Pw_100"><em>*</em>Logo：</span>
            <asp:FileUpload ID="fileUpload" runat="server" CssClass="forminput" />
              <div>图片尺寸建议：650px*200px</div>
          </li>
          <li> <span class="formitemtitle Pw_100">官方地址：</span>
            <asp:TextBox ID="txtCompanyUrl" CssClass="forminput" runat="server" />
            <p id="ctl00_contentHolder_txtCompanyUrlTip">官方网站的网址必须以http://开头，长度限制在100个字符以内'</p>
          </li>
          ...
          <li> <span class="formitemtitle Pw_100">介绍：</span>
           <Kindeditor:KindeditorControl ID="fckDescription" runat="server"  Height="300"/>
          </li>
          <li  style="display:<%=Hidistro.ControlPanel.Config.CustomConfigHelper.Instance.BrandShow?"none":"" %>"> <span class="formitemtitle Pw_100">关联商品类型：</span>
...
<asp:Content ID="Content3" ContentPlaceHolderID="validateHolder" runat="server">
 <script type="text/javascript" language="javascript">
            function InitValidators() {
                initValid(new InputValidator('ctl00_contentHolder_txtBrandName', 1, 30, false, null, '名称不能为空，长度限制在30个字符以内'));
                initValid(new InputValidator('ctl00_contentHolder_txtCompanyUrl', 0, 100, true, '^(http)://.*', '官方网站的网址必须以http://开头，长度限制在100个字符以内'));
