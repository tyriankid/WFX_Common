...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
    ...
    <div class="datalist">
     <UI:Grid ID="grdConsultation" runat="server" ShowHeader="true" AutoGenerateColumns="false" DataKeyNames="ConsultationId" HeaderStyle-CssClass="table_title" CssClass="goods-list" GridLines="None" Width="100%">
                    <Columns>
                        <asp:TemplateField SortExpression="ProductName" HeaderText="咨询商品"  >
                        ...
                        <asp:TemplateField ItemStyle-Width="12%" HeaderText="咨询时间" SortExpression="ConsultationDate" ItemStyle-CssClass="td_txt_cenetr">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderStyle-Width="95px" HeaderText="操作"  ItemStyle-CssClass="td_txt_cenetr" >
           
                            <ItemTemplate><a href="javascript:DialogFrame('<%# Globals.GetAdminAbsolutePath(string.Format("/comment/ReplyProductConsultations.aspx?ConsultationId={0}", Eval("ConsultationId")))%>','回复客户咨询',null,null)">回复</a>  
