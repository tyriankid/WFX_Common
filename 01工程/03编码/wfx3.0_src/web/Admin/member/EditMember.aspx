    ...
    <div class="areacolumn clearfix">
      ...
      <div class="formitem validator4 clearfix">
        <ul>
          ...
          <!--后台采购商激活功能-->
          <li style="display:<%=Hidistro.ControlPanel.Config.CustomConfigHelper.Instance.IsBuyerNeedsToBeActive?"block":"none"%>"> <span class="formitemtitle Pw_110">采购商激活状态：</span>
              <asp:DropDownList ID="DDLMemberActive" runat="server">
                  <asp:ListItem Value="1">激活</asp:ListItem>
                  <asp:ListItem Value="0">未激活</asp:ListItem>
              </asp:DropDownList>
          </li>

          <li style="display:none"> <span class="formitemtitle Pw_110">详细地址：</span>
            <Hi:RegionSelector runat="server" ID="rsddlRegion" />
          </li>
          <li style="display:none"> <span class="formitemtitle Pw_110">街道地址：</span>
