...
<asp:Content ID="Content1" ContentPlaceHolderID="contentHolder" runat="server">
  ...
  <div class="dataarea mainwidth databody">
    ...
    <div class="formitem">
                <ul>
                  <li> <span class="formitemtitle Pw_101">咨询用户：</span><asp:Literal ID="litUserName" runat="server"></asp:Literal></li>
                  
                  <li> <span class="formitemtitle Pw_101">咨询时间：</span><Hi:FormatedTimeLabel ID="lblTime" runat="server"></Hi:FormatedTimeLabel></li>
                  <li> <span class="formitemtitle Pw_101">咨询内容：</span><abbr class="colorQ"><asp:Literal ID="litConsultationText" runat="server"></asp:Literal></abbr></li>
                  <li > <span class="formitemtitle Pw_101">回复：</span> 
