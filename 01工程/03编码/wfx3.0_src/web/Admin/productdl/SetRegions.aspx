...
<%@ Page Language="C#"  MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SetRegions.aspx.cs" Inherits="Hidistro.UI.Web.Admin.product.SetRegions" %>
            ...
            <div class="formitem validator1">
                <ul>
                    ...
                    <li>
                        ...
                        <a id="addDeliveryScop" class="submit_jia" href="javascript:void(0)" style="color: #fff;">添加商品所属范围</a>
                    </li>
                    <li>
