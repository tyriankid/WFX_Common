	    ...
	    <div class="formitem validator1">
          ...
          <li><h2 class="colorE">基本信息</h2></li>
	        ...
	        <li>
	            ...
	            <span id="spDropDownList" runat="server">品牌：</span><abbr class="formselect" style="visibility:visible"><Hi:BrandCategoriesDropDownList  runat="server" ID="dropBrandCategories" NullToDisplay="--请选择--" /></abbr>
            </li>
            <li>
