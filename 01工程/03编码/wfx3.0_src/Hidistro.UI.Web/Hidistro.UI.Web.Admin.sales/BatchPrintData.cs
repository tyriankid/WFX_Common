    ...
    public class BatchPrintData : AdminPage
    {
        ...
        private void printdata()
        {
            ...
            if (System.IO.File.Exists(path))
            {
                ...
                pic = node.SelectSingleNode("pic").InnerText;
        ...
        private void PrintPage(string pagewidth, string pageheght)
        {
            ...
            string imgHtml = "\"<img border='0' src='" + string.Format("../../Storage/master/flex/{0}", pic) + "'>\"";
            builder.Append(" LODOP.ADD_PRINT_SETUP_BKIMG("+imgHtml+");");
            ...
            builder.Append(" LODOP.SET_SHOW_MODE('BKIMG_PRINT',1);");
