<%@ Page Language="C#" AutoEventWireup="true" Inherits="Hidistro.UI.Web.Admin.AliOH.ManageAMenu" CodeBehind="~/Admin/vshop/ManageMenu.aspx.cs" MasterPageFile="~/Admin/Admin.Master" %>
...
<div class="dataarea mainwidth databody">
  ...
  <span>自定义菜单能够帮助公众号丰富界面，让用户更好更快地理解公众号的功能。</span></div>  
	<div class="btn">	
   <span style="margin-right:13px;">目前自定义菜单最多包括3个一级菜单，每个一级菜单最多包含5个二级菜单。一级菜单最多4个汉字，二级菜单最多7个汉字，多出来的部分将会以“...”代替。</span></btn>
   </div>
