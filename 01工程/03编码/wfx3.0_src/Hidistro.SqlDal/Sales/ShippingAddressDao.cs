namespace Hidistro.SqlDal.Sales
{
    ...
    public class ShippingAddressDao
    {
        ...
        {
            DbCommand sqlStringCommand = this.database.GetSqlStringCommand("INSERT INTO Hishop_UserShippingAddresses(RegionId,UserId,ShipTo,Address,Zipcode,TelPhone,CellPhone,IsDefault,lat,lng) VALUES(@RegionId,@UserId,@ShipTo,@Address,@Zipcode,@TelPhone,@CellPhone,@IsDefault,@lat,@lng); SELECT @@IDENTITY");
            ...
            this.database.AddInParameter(sqlStringCommand, "lat", DbType.Decimal, shippingAddress.lat);
            this.database.AddInParameter(sqlStringCommand, "lng", DbType.Decimal, shippingAddress.lng);
