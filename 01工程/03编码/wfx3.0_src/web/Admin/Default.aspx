...
<div class="hishop_list_content">
    <div class="hishop_list_l">
        ...
        <table>
            ...
            <tr>
                ...
                <td class="td_cont_left">当前版本</td><td class="sp_img">V1.5</td>
            </tr>
            <tr>
            </tr>
        </table>
    ...
    <div class="hishop_list_r">
             <div class="hishop_contenttitle">微分销动态</div>
          <div class="hishop_list_tab">
              <div style="height:370px;">
              <%--<Hi:HiControls LinkURL="http://zzu.cc/hishop.htm" runat="server" Height="370" ID="HiControlsId"/>--%>              
            </div>
          </div>
    </div>
</div>
