...
namespace Hidistro.UI.Web.Admin
{
	...
	public class ProductOnSales : AdminPage
	{
        ...
        protected DropDownList DDLReviewState;
		...
		private void BindProducts()
		{
            ...
            DbQueryResult products = new DbQueryResult();
            if (ManagerHelper.GetRole(currentManager.RoleId).RoleName.IndexOf("门店") >= 0)//如果当前是门店角色,则读取门店商品
            {
                products = ProductHelper.GetProductsByStoreId(entity);
            }
            else
            {
               products = ProductHelper.GetProducts(entity);
            }
        ...
        private void DDLReviewState_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			this.ReloadProductOnSales(true);
		}
		...
		private void LoadParameters()
		{
            ...
            if (!string.IsNullOrEmpty(this.Page.Request.QueryString["ReviewState"]))
            {
                this.reviewState = this.Page.Request.QueryString["ReviewState"].ToInt();
            }
            ...
            this.DDLReviewState.SelectedValue = this.reviewState.ToString();
		}
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            this.DDLReviewState.SelectedIndexChanged += new System.EventHandler(this.DDLReviewState_SelectedIndexChanged);
            
			if (!this.Page.IsPostBack)
			{
                this.DDLReviewState.SelectedIndex = -1;
        ...
        public static string submmitReview(string ProductIds)
        {
		...
		private void ReloadProductOnSales(bool isSearch)
		{
            ...
            queryStrings.Add("ReviewState", this.DDLReviewState.SelectedValue.ToString());
