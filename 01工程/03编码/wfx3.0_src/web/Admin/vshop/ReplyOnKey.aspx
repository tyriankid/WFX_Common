        ...
        <div class="datalist">
            <UI:Grid ID="grdArticleCategories" runat="server" ShowHeader="true" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="回复类型"  ItemStyle-CssClass="td_txt_cenetr" >
                        <ItemTemplate>
                            <asp:Literal runat="server" Text='<%# GetReplyTypeName(Eval("ReplyType")) %>'></asp:Literal>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="立即发布"  ItemStyle-CssClass="td_txt_cenetr">
                    <ItemTemplate>
                        <div class="infoTitle">
                    ...
                    <asp:TemplateField HeaderText="最后修改日期"  ItemStyle-CssClass="td_txt_cenetr">
                        <ItemTemplate>
                            <asp:Literal runat="server" Text='<%# Eval("LastEditDate") %>'></asp:Literal>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="最后修改人"  ItemStyle-CssClass="td_txt_cenetr">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="操作" HeaderStyle-Width="95"  ItemStyle-CssClass="td_txt_cenetr">
                        ...
                        <ItemTemplate>
                            ...
                            <Hi:ImageLinkButton ID="lkDelete" Text="删除" IsShow="true"  CommandName="Delete" runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </UI:Grid>
