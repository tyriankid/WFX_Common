...
namespace Hidistro.UI.Web.Admin
{
	public class VServerConfig : AdminPage
	{
        ...
        protected System.Web.UI.HtmlControls.HtmlInputCheckBox chk_flowWindow;
		protected void btnOK_Click(object sender, System.EventArgs e)
		{
            ...
            masterSettings.isFlowWindowsOn = this.chk_flowWindow.Checked;
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!this.Page.IsPostBack)
			{
				...
				this.txtUrl.Text = string.Format("http://{0}/api/wx.ashx?sdf", base.Request.Url.Host, this.txtToken.Text);
                ...
                this.chk_flowWindow.Checked = masterSettings.isFlowWindowsOn;
			}
		}
	}
}
