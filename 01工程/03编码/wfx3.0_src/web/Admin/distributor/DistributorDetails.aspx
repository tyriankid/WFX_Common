...
<div class="areacolumn clearfix">
      <div class="columnright">
        ...
        <div class="formitem clearfix">
          ...
          <li><span class="formitemtitle Pw_110">店铺名：</span><span style="padding-top:3px;"><asp:TextBox runat="server" ID="txtStoreName" /></span></li>
      ...
      <ul class="btn Pa_110">
          <asp:Button runat="server" ID="btnSave" CssClass="submit_DAqueding" style="float: left;" Text="保存" />
          <asp:Button runat="server" ID="btnSubmit" CssClass="submit_DAqueding" style="float: left;" Text="返回" />
