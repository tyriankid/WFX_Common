...
function addWBTP(e) {
    ...
    var divhtml2 = "<li id='nav_li" + n + "' n='" + n + "' style='background-position:15px -29px;'><label><input type='radio' name='multiple' /><span>未命名的选项</span></label></li>";
    ...
    $("#addAttr" + m + " input[name='options']").change(function () {
        var k = $(this).parents("tr").attr("n");
