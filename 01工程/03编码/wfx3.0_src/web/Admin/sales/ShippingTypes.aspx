	...
	<div>
	 <UI:Grid ID="grdShippingModes" runat="server" ShowHeader="true" AutoGenerateColumns="false" DataKeyNames="ModeId" GridLines="None" Width="100%" HeaderStyle-CssClass="border_background">
          <HeaderStyle CssClass="table_title" />
            <Columns>   
                    <asp:TemplateField HeaderText="方式名称"  ItemStyle-CssClass="td_txt_cenetr">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="运费模板"  ItemStyle-CssClass="td_txt_cenetr">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="缺省价" ItemStyle-CssClass="td_txt_right" >
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="加价" ItemStyle-CssClass="td_txt_right">
                     ...
                     <UI:SortImageColumn HeaderText="排列序号"  ItemStyle-CssClass="td_txt_cenetr" />
