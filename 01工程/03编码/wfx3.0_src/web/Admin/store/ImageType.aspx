	...
	<div class="datalist">
		...
		<div class="imageDataLeft" id="ImageDataList">
			 <UI:Grid ID="ImageTypeList" runat="server" AutoGenerateColumns="false" ShowHeader="true" DataKeyNames="CategoryId" GridLines="None" Width="100%" HeaderStyle-CssClass="table_title">
			  <Columns>
				  <asp:TemplateField HeaderText="分类名称" ItemStyle-Width="14%" ItemStyle-CssClass="td_txt_cenetr">
						<ItemTemplate>
						   <Hi:HtmlDecodeTextBox ID="ImageTypeName" runat="server" Text='<%# Bind("CategoryName") %>' CssClass="forminput" />
						</ItemTemplate>
				  </asp:TemplateField>
				   <UI:SortImageColumn HeaderText="排序" ReadOnly="true" ItemStyle-Width="14%"  ItemStyle-CssClass="td_txt_cenetr" />
		...
		<div class="btn_bottom"><asp:Button ID="ImageTypeEdit" runat="server" Text="确定修改"  CssClass="btn-blue float" />
			   <asp:Button ID="ImageTypeAdd" runat="server" OnClientClick="ImageType(); return false;" Text="添加分类" CssClass="btn-gray" /></div>
	</div>
</div>	
