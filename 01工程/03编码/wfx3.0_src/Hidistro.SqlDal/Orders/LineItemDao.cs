    ...
    public class LineItemDao
    {
        ...
        public bool AddOrderLineItems(string orderId, ICollection lineItems, DbTransaction dbTran)
        {
            ...
            foreach (LineItemInfo info in lineItems)
            {
                ...
                builder.Append("INSERT INTO Hishop_OrderItems(OrderId, SkuId, ProductId, SKU, Quantity,GiveQuantity,HalfQuantity, ShipmentQuantity, CostPrice").Append(",ItemListPrice, ItemAdjustedPrice, ItemDescription, ThumbnailsUrl, Weight, SKUContent, PromotionId, PromotionName,OrderItemsStatus,ItemsCommission,SecondItemsCommission,ThirdItemsCommission) VALUES(@OrderId").Append(",@SkuId").Append(str).Append(",@ProductId").Append(str).Append(",@SKU").Append(str).Append(",@Quantity").Append(str).Append(",@GiveQuantity").Append(str).Append(",@HalfQuantity").Append(str).Append(",@ShipmentQuantity").Append(str).Append(",@CostPrice").Append(str).Append(",@ItemListPrice").Append(str).Append(",@ItemAdjustedPrice").Append(str).Append(",@ItemDescription").Append(str).Append(",@ThumbnailsUrl").Append(str).Append(",@Weight").Append(str).Append(",@SKUContent").Append(str).Append(",@PromotionId").Append(str).Append(",@PromotionName").Append(str).Append(",@OrderItemsStatus").Append(str).Append(",@ItemsCommission").Append(str).Append(",@SecondItemsCommission").Append(str).Append(",@ThirdItemsCommission").Append(str).Append(");");
                ...
                this.database.AddInParameter(sqlStringCommand, "HalfQuantity" + str, DbType.Int32, info.HalfPriceQuantity);
