...
<asp:GridView ID="grdPaymentMode" runat="server" AutoGenerateColumns="false" ShowHeader="true" Width="100%" DataKeyNames="ModeId" GridLines="None">
                 <HeaderStyle CssClass="table_title" /> 
                   <Columns>
                        ...
                        <UI:SortImageColumn HeaderText="显示顺序"  ItemStyle-CssClass="td_txt_cenetr" />
                        <asp:TemplateField HeaderText="操作" ItemStyle-Width="20%"  ItemStyle-CssClass="td_txt_cenetr">
                            <ItemTemplate>
