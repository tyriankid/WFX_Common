namespace Hidistro.Entities.Commodities
{
    ...
    public class BrandCategoryInfo
    {
        ...
        [StringLengthValidator(1, 30, Ruleset="ValBrandCategory", MessageTemplate="名称不能为空，长度限制在30个字符以内")]
        public string BrandName { get; set; }

        [RegexValidator("^(http)://.*", Ruleset="ValBrandCategory"), NotNullValidator(Negated=true, Ruleset="ValBrandCategory"), ValidatorComposition(CompositionType.Or, Ruleset="ValBrandCategory", MessageTemplate="官方网站的网址必须以http://开头，长度限制在100个字符以内")]
        public string CompanyUrl { get; set; }

        [StringLengthValidator(0, 300, Ruleset="ValBrandCategory", MessageTemplate="介绍的长度限制在300个字符以内")]
