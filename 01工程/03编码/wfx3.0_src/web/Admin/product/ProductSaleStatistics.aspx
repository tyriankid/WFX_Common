      ...
      <div class="functionHandleArea clearfix m_none">
	   ...
	   <UI:Grid ID="grdProductSaleStatistics" runat="server" ShowHeader="true" AutoGenerateColumns="false" HeaderStyle-CssClass="table_title" GridLines="None" Width="100%">
                    ...
                    <asp:TemplateField HeaderText="排行" ItemStyle-CssClass="td_txt_cenetr">
                        ...
                        <asp:BoundField HeaderText="访问次数" DataField="VistiCounts" ItemStyle-CssClass="td_txt_cenetr" />
                         <asp:TemplateField HeaderText="购买次数"  ItemStyle-CssClass="td_txt_cenetr">
                            <ItemTemplate>
                                <asp:Label ID="lblBuyCount"  runat="Server" Text='<%# Eval("BuyCount") %>' />
                            </ItemTemplate>
                        </asp:TemplateField> 
                        <asp:TemplateField HeaderText="访问购买率"  ItemStyle-CssClass="td_txt_cenetr">
                            <ItemTemplate>
