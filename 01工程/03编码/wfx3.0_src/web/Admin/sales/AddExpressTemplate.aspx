			  ...
			  <div class="datalist">
				...
				margin:0px 0px 5px 0px;">
				  ...
				  <tr>
					...
					<td width="42" class="tdline"><form name="form3">
					  <label><button name="btndata" onClick="getData()" type="button" class="link_default_blue">保存
							</button></label>
					</form></td>
					...
					<td width="49"><form name="form6">
					  <label><button name="btnclick"
							onClick ="clickbtn();return false;" class="link_default_orange">上传
							</button></label>
					</form></td>
					<td width="48" class="tdline"><form name="form7">
					  <label><button name="btnimage"
							onClick ="imagebtn();return false;" class="link_default_gray">删除
							</button></label>
					</form></td>
				...
				size="1">
					...
					<td width="54" class="tdline"><form name="form9">
					  <label><button name="btnitem" onClick="delData()"  type="button" class="link_default_gray">删除
							</button></label>
					</form></td>
					<td class="tdline"></td>
					<td></td>
