    ...
    <asp:DataList ID="dlstVote" runat="server" Width="100%" DataKeyField="VoteId">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr class="table_title">
                      ...
                      <th width="180" class=" td_left td_right_fff">操作</td>
                    </tr>
            </HeaderTemplate>
            <ItemTemplate>
              <tr>
                <%--<td  class="td_txt_cenetr"><img src="../../utility/pics/plus.gif" onclick="errorEventTable(this);" /></td>--%>
                <td>
                ...
                <%--<td class="td_txt_cenetr"><asp:Label ID="lblMaxCheck" runat="server" Text='<%# Eval("MaxCheck") %>' ></asp:Label></td>--%>
                <td class="td_txt_cenetr"><asp:Label ID="lblVoteCounts" runat="server" Text='<%# Eval("VoteCounts") %>' ></asp:Label></td>
                ...
                <td><span class="submit_bianji" style="width: 23px; float: left; padding-top: 6px;line-height: 23px;height: 23px;display:none"><span id="spcopy<%#Container.ItemIndex+1 %>" title="复制"></span></span>
                   ...
                   <span class="submit_bianji"><a href='<%# Globals.GetAdminAbsolutePath("/HomePage/HomePageVote.aspx?VoteId=" + Eval("VoteId"))%>&reurl=<%=LocalUrl %>' style="margin-right:5px;">配置模块</a></span>
                   <span class="submit_shanchu"><Hi:ImageLinkButton ID="lkbDelete"  runat="server"  CommandName="Delete" Text="删除" IsShow="true" /></span>
                   <span class="submit_bianji"><a href='<%# Globals.GetAdminAbsolutePath("/store/VoteResultInfo.aspx?VoteId=" + Eval("VoteId"))%>&reurl=<%=LocalUrl %>' style="margin-right:5px;">查看结果信息</a></span> 
