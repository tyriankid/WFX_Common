...
using System.Xml;
    ...
    public static class StoreHelper
    {
        ...
        public static DbQueryResult GetDeliveryMemberList(DeliveryMemberQuery query)
        {
            return new StoreDao().GetDeliveryMemberList(query);
        }

        public static bool CreateDeliveryMember(DeliveryMemberInfo entity,bool isAdd)
        {
            return new StoreDao().CreateDeliveryMember(entity, isAdd);
        }

        public static DeliveryMemberInfo GetDeliveryMemberInfo(int userid)
        {
            return new StoreDao().GetDeliveryMemberInfo(userid);
        }
    }
}
