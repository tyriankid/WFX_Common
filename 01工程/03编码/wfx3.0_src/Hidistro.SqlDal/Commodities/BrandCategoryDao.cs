namespace Hidistro.SqlDal.Commodities
{
    ...
    public class BrandCategoryDao
    {
        ...
        public bool BrandHvaeProducts(int brandId)
        {
            ...
            this.database.AddInParameter(sqlStringCommand, "BrandId", DbType.String, brandId);
        ...
        public DataTable GetBrandsShow(int brandId)
        {
        ...
        public DataTable GetBrandsShow(string brandIds)
        {
            DbCommand sqlStringCommand = this.database.GetSqlStringCommand("SELECT * FROM Hishop_BrandCategories where  BrandId in(" + brandIds + ")");
            using (IDataReader reader = this.database.ExecuteReader(sqlStringCommand))
            {
                return DataHelper.ConverDataReaderToDataTable(reader);
            }
